      ...
      <form @submit.prevent="saveProject(false)" class="space-y-8 divide-y divide-gray-200">
        ...
        <div class="pt-5 pb-10">
          <div class="flex justify-end gap-x-3">
            ...
            <button type="button" @click="saveProject(false)" :disabled="submitting" class="inline-flex justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-blue-600 shadow-sm ring-1 ring-inset ring-blue-300 hover:bg-blue-50 disabled:opacity-50">
              Simpan Perubahan
            </button>
            <button type="button" @click="saveProject(true)" :disabled="submitting" class="inline-flex justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:opacity-50">
